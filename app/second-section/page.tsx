        ...
        <div className="p-5 justify-center md:w-1/3">
          <div
            className="bg-gradient-to-r
                ...
                "
          >
            Lorem ipsum dolor, sit amet consectetur lorem fsaffm sferersd
          </div>
          <div className="text-2xl mb-8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae repudiandae dolorum earum suscipit!
          </div>
